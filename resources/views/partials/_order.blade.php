                    ...
                    <div class="col-md-4">
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                {{-- <button type="button" class="btn  btn-block btn-round  btn-info"
                                    data-dismiss="modal">
                                    {{
                                    __('lang.message') }}</button> --}}

                                <div class="conversation">
                                    <a href="{{ route('messages.conversation',$order->id.'?message=customer&pharmacy=' ) }}"
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="{{ $order->user->avatar ?? 'https://ph.bravo-care.com/images/defaults/logomarks.png' }}"
                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <label class="control-label">
                                    {{ __('lang.driver_id') }} {{$order->driver->id}}
                                </label>
                                <h2>{{$order->driver->name}}</h2>

                                <div class="conversation">
                                    <a href="{{ route('messages.conversation',$order->id.'?message=driver') }}" {{--
                                        action="{{ route('accounts.accounts.update', $user->id ) }}" --}}
                                        class="btn  btn-block btn-round  btn-info">
                                        ...
                                        <div class="avatar">
                                            ...
                                            <img src="{{ $order->driver->avatar ?? 'https://ph.bravo-care.com/images/defaults/logomarks.png' }}"
                                                style="width: 10%; height: 10%;">
                                        </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="email" value="{{ $order->driver->email }}"
                                                class="form-control" autocomplete="off" disabled>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="phone" value="{{ $order->driver->phone }}"
                                                class="form-control" autocomplete="off" disabled>
                                        </div>
                                    </div>
                                </div>
