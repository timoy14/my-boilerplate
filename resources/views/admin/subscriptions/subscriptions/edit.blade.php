...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('subscriptions.subscriptions.update', $subscription->id) }}" method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <textarea name="descriptions[]" class="form-control multiple"
                                        onfocusout="descriptionsout()" id="descriptions" multiple="multiple"
                            ...
                            <div class="col-md-1">
                                <div class="form-group">
                                    ...
                                    <input class="checkbox-input" name="multiple_branch" id="multiple_branch"
                                        ...
                                        {{ $subscription->multiple_branch ? 'checked': '' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="advertisement_limit" id="advertisement_limit"
                                        ...
                                        {{ $subscription->multiple_branch ? '': 'disabled' }}>
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="offer_limit" id="offer_limit"
                                        value="{{$subscription->offer_limit}}" class="form-control" step="any"
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="number" name="branch_employee_limit" id="branch_employee_limit"
                                        ...
                                        {{ $subscription->employee ? '': 'disabled' }}>
...
<script type="text/javascript">
	...
	if(keycode == '13'){
        ...
        $('#description').val(JSON.stringify( array ));
        // $('input:hidden[name=description]').val(JSON.stringify( array ));
