...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin-products.products.store' ) }}"
             method="POST"
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="scientific_name_arabic" 
                                     class="form-control"
                                        autocomplete="off">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="trade_name_arabic" 
                                     class="form-control"
                                        autocomplete="off">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="strength_unit" 
                                     class="form-control"
                                        autocomplete="off">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="size_unit" 
                                     class="form-control"
                                        autocomplete="off">
