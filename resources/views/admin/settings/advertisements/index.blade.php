        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ route('settings.advertisements.create')}}"
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="5%">
                                        <form action="{{ route('settings.advertisements.destroy', $advetisement->id) }}"
                                    ...
                                    <td width="5%">
                                        <a href="{{ route('settings.advertisements.edit' , $advetisement->id )}}"
                                    ...
                                    <td width="5%">
                                        <button class="btn btn-info btn-round btn-sm" data-toggle="modal"
                                            data-target="#ViewModal" data-en="{{ $advetisement->en }}"
                                            data-ar="{{ $advetisement->ar }}"
                                            data-description="{{ $advetisement->description}}"
                                            data-display="{{ $advetisement->display}}"
                                            data-image="{{ $advetisement->image}}"
                                            data-category="{{ (session()->get('locale') === 'ar') ? $advetisement->category->ar: $advetisement->category->en}}">
                                            {{ __('lang.view') }}
                                        </button>
                                    </td>
                                    <td width="5%">
                                        @if ($advetisement->display == 1 )
                                        <a href="{{ route('settings.advertisements.show' , $advetisement->id )}}"
                                    ...
                                    <td>
                                        {{ (session()->get('locale') === 'ar') ? $advetisement->category->ar: $advetisement->category->en}}
                                    </td>
                                    <td>{{ $advetisement->ar }}</td>
                                    <td>{{ $advetisement->en }}</td>
