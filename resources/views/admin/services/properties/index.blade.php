                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12 pull-left">
                            <a href="{{ route('services.properties.create')}}"
                                class="btn btn-success btn-round btn-md mt-2">{{ __('lang.properties') }} <i
                        ...
                        <div class="col-md-12 mt-1">
                            ...
                            <a href="{{ route('services.properties.index') }}"
...
$("#approve").on('click', function(){
  ...
  $('#filter_type , #filter_status, #filter_owner').change( function() {
   ...
   var x = location.origin;
  var link = x+'/services/properties/type/'+type+'/status/'+status+'/owner/'+owner;
