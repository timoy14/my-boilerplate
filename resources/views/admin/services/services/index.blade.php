            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12 mt-1 pull-right">
                            <label><strong>{{ __('lang.filter') }} </strong></label>
                            <a href="{{ route('services.services.index') }}" class="btn btn-inverse-danger ">
                                {{ __('lang.reset') }}
                            </a>
                        </div>
                    </div>
                    <form action="" id="filter_form">
                        <div class="row">
                            ...
                            <div class="col-md-4 mt-1 pull-right">
                                ...
                                <select id="filter_category" class="form-control" value="{{ $selected_category->id}}">
                                    <option selected disabled value="{{ $selected_category->id}}">
                                        {{ (session()->get('locale') === 'ar') ? $selected_category->ar: $selected_category->en}}
                                    </option>
                                    ...
                                    <option value="{{$category->id}}" dir="rtl">
...
$("#approve").on('click', function(){
  ...
  $('#filter_category , #filter_status, #filter_owner').change( function() {
   ...
   if (category == null) {
      var category = "<?php echo  $selected_category->id; ?>";
   }
   if (owner == null) {
   ...
   var x = location.origin;
  var link = x+'/services/category/'+category+'/status/'+status+'/owner/'+owner;
