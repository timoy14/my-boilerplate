                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12 pull-left">
                            <a href="{{ route('services.cars.create')}}"
                                class="btn btn-success btn-round btn-md mt-2">{{ __('lang.cars') }} <i
                        ...
                        <div class="col-md-12 mt-1">
                            ...
                            <a href="{{ route('services.cars.index') }}" class="btn  btn-danger btn-round btn-md mt-2">
                                {{ __('lang.reset') }}
                            </a>
                        </div>
                    </div>
...
$("#approve").on('click', function(){
  ...
  $('#filter_type , #filter_status, #filter_owner').change( function() {
   ...
   var x = location.origin;
  var link = x+'/services/cars/type/'+type+'/status/'+status+'/owner/'+owner;
