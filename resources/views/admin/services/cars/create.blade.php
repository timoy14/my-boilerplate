...
<div class="container-fluid center">
   <div class="row">
      <div class="col-md-12">
         <form action="{{ route('services.cars.store') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card">
               <div class="card-header">
                  {{ __('lang.car') }} {{ __('lang.rentals') }}
               </div>
               <div class="card-body">

                  <!-- User  name-->
                  <h4 class="my-3 text-right"> {{ __('lang.car') }} {{ __('lang.inforamtion') }}</h4>
                  <div class="row">
                  ...
                  <div class="row">
                     <div class="col-md-4">
                        <div class="form-group">
                           ...
                           <input type="number" name="car_count" value="{{ old('car_count') }}" class="form-control"
                              autocomplete="off">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <label class="control-label">
                              {{ __('lang.date_manufacture') }}
                           </label>
                           <input type="text" name="date_manufacture" value="{{ old('date_manufacture') }}"
                        ...
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[thursday]"
                                 value=" {{ old('general_price[thursday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[wednesday]"
                                 value="{{ old('general_price[wednesday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[tuesday]"
                                 value="{{ old('general_price[tuesday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                        <div class="col-md-3">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[monday]"
                                 value="{{ old('general_price[monday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[friday]"
                                 value="{{ old('general_price[friday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[saturday]"
                                 value="{{ old('general_price[saturday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                        <div class="col-md-4">
                           <div class="form-group">
                              ...
                              <input type="number" name="general_price[sunday]"
                                 value="{{ old('general_price[sunday]') }}" class="form-control" autocomplete="off"
                                 step="any">
                           </div>
                        </div>
                     </div>
               ...
               <div class="card-footer">
                  <a href="{{ route('services.cars.index') }}" class="btn btn-inverse-primary ">
                     {{ __('lang.back') }}
                  </a>
            ...
            <div class="row">
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="number" id="sp_thursday" value="0" class="form-control" autocomplete="off" step="any">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
               ...
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="number" id="sp_tuesday" value="0" class="form-control" autocomplete="off" step="any">
                  </div>
               </div>
               <div class="col-md-3">
                  <div class="form-group">
                     ...
                     <input type="number" id="sp_monday" value="0" class="form-control" autocomplete="off" step="any">
                  </div>
               </div>
            </div>
            <div class="row">
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="number" id="sp_friday" value="0" class="form-control" autocomplete="off" step="any">
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="number" id="sp_saturday" value="0" class="form-control" autocomplete="off" step="any">
                  </div>
               </div>
               <div class="col-md-4">
                  <div class="form-group">
                     ...
                     <input type="number" id="sp_sunday" value="0" class="form-control" autocomplete="off" step="any">
                  </div>
               </div>
            </div>
         </div>
