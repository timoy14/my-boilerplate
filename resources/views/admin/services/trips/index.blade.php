                ...
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12 pull-left">
                            <a href="{{ route('services.trips.create')}}"
                                class="btn btn-success btn-round btn-md mt-2">{{ __('lang.trips') }} <i
...
$("#approve").on('click', function(){
  ...
  $('#filter_type , #filter_status, #filter_owner').change( function() {
   ...
   var x = location.origin;
  var link = x+'/services/trips/type/'+type+'/status/'+status+'/owner/'+owner;
