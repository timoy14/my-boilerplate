...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin-users.owners.store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card">
 ...
 -->
                    ...
                    <div class="card-footer">
                        <a href="{{ route('admin-users.owners.index') }}" class="btn btn-inverse-primary float-right">
                            {{ __('lang.back') }}
                        </a>
