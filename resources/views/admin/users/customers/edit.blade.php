...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('admin-users.customers.update', $user->id ) }}" method="POST"
                ...
                <div class="card">
                            ...
                            <div style="display: none;" class="col-md-6 ">
                                <div class="form-group">
                                    <div class="offset-md-3 col-md-4 ">
                                        <img style="margin-top: 20%;"src="{{ ($user->avatar) ? asset('storage/'.$user->avatar): asset('images/defaults/logo.png') }}"
                    ...
                    <div class="card-footer">
                        <a href="{{ route('admin-users.customers.index') }}" class="btn btn-inverse-primary">
                            {{ __('lang.back') }}
                        </a>
