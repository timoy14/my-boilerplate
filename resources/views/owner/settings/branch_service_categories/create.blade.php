...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('owner-settings.branch_service_categories.store') }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <select name="branch_category_icon" class="form-control"
                                                    id="id_select2_example" style="width: 200px;"
