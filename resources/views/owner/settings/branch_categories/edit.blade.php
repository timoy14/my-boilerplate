...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('settings.subcategories.update' , $subcategory->id) }}" method="POST"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <img src="{{ asset('storage/'.$subcategory->image)}}" id="preview"
