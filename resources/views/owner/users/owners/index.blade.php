        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="{{ route('users.owners.create')}}"
                    ...
                    <div class="table-responsive">
                        <table id="table" class="table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td width="5%">
                                        <form action="{{ route('users.owners.destroy', $owner->id) }}" class="wbd-form"
                                            method="POST">
                                            {{ csrf_field() }}
                                            {{ method_field('DELETE') }}
                                    ...
                                    <td width="5%">
                                        <a href="{{ route('users.owners.edit' , $owner->id )}}"
                                            class="btn btn-warning btn-round btn-sm">
                                            {{ __('lang.update') }}
                                        </a>
                                    </td>
                                    <td width="5%">
                                        <a href="{{ route('users.owners.show' , $owner->id )}}"
