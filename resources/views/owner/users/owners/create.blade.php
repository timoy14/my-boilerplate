...
<div class="container-fluid center">
   <div class="row">
      <div class="col-md-12">
         <form action="{{ route('users.owners.store') }}" method="POST" enctype="multipart/form-data">
            {{ csrf_field() }}
            <div class="card">
               ...
               <div class="card-body">
                  <div class="row">
                     ...
                     <div class="col-md-4">
                        <div class="form-group">
                           <img src="{{  asset('images/defaults/logo.png') }}" id="preview" class="logo-icon img-centered">
                        </div>
                     </div>
                  </div>
                  <div class="row">
                  ...
                  <div class="row">
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="phone" value="{{ old('phone') }}" maxlength="10" class="form-control" autocomplete="off"> 
                           @if ($errors->has('phone'))
                           <span class="text-danger">
                  ...
                  <div class="row">
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="bank_account_num" value="{{ old('bank_account_num') }}" class="form-control" autocomplete="off"> 
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="bank_name" value="{{ old('bank_name') }}" class="form-control" autocomplete="off"> 
               ...
               <div class="card-footer">
                  <a href="{{ route('users.owners.index') }}" class="btn btn-inverse-primary "> 
                  {{ __('lang.back') }}
                  </a>
