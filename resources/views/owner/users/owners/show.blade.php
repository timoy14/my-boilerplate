...
<div class="container-fluid center">
    <div class="row">
        <div class="col-md-12">
            <form action="{{ route('owner-users.owners.store') }}" method="POST" enctype="multipart/form-data">
                {{ csrf_field() }}
                <div class="card">
                    <div class="card-header">
                        {{ __('lang.owners') }}
                        <a href="{{ route('owner-users.owners.edit', $user->id) }}"
                            class="btn btn-success btn-sm">{{ __('lang.update') }}
 ...
 -->
                     ...
                     <div class="col-md-6">
                        <div class="form-group">
                           ...
                           <input type="text" name="password" value="{{ old('password') }}" class="form-control" autocomplete="off">
