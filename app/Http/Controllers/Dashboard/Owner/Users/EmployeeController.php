...
class EmployeeController extends Controller
{
    ...
    public function index()
    {
        ...
        if (Auth::user()->isOwner()) {
            ...
            if ($branches_count == 0) {
                ...
                $employees = User::where('parent_id', Auth::user()->category_id)->get();
                return view('owner.branches.create', compact('subcategories', 'employees'));
            }

            $employees = User::where('parent_id', Auth::user()->id)->whereHas('role', function ($q) {
                $q->where('id', 5);
            })->orderBy('id', 'desc')->get();

            return view('owner.users.employees.index', compact('employees'));
    ...
    public function create()
    {
        ...
        $cities = City::all();
        $genders = Gender::all();
        return view('owner.users.employees.create', compact('genders', 'cities', 'branches'));
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect()->route('owner-users.employees.index')->with(['message' => __('lang.successfully_added')]);
    }
    ...
    public function show(Request $request, $id)
    {
        ...
        return view('owner.users.employees.show', compact('unavailabilities', 'bookings', 'week_ar', 'today', 'days', 'add_space', 'week', 'add_space_end', 'year_month', 'branches', 'user', 'genders', 'cities'));
    }
    ...
    public function edit($id)
    {
        ...
        $cities = City::all();
        $genders = Gender::all();
        return view('owner.users.employees.edit', compact('branches', 'user', 'genders', 'cities'));
    }
    ...
    public function update(Request $request, $id)
    {
        ...
        return redirect()->route('owner-users.employees.index')->with(['message' => __('lang.successfully_updated')]);
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('owner-users.employees.index')->with(['message' => __('lang.successfully_deleted')]);
    }
}